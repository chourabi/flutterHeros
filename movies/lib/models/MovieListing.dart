...
//
//     final movieListing = movieListingFromJson(jsonString);

import 'dart:convert';

MovieListing movieListingFromJson(String str) => MovieListing.fromJson(json.decode(str));

String movieListingToJson(MovieListing data) => json.encode(data.toJson());
...
class MovieListing {
    ...
    factory MovieListing.fromJson(Map<String, dynamic> json) => MovieListing(
